...
class Type extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      head: ["S.N", "Profile", "Category", "Name", "Score", "Description", "Action"],
      body: [],
      filter: [
        {
          key: "sn",
  ...
  async remove(id) {
    if (confirm("Are you sure!")) {
      try {
        await Api.init(Routes.type.delete.remove(id), {});
  ...
  view(id) {
    window.location.href = `/category_type_detail?id=${id}`;
  }

  add() {
    window.location.href = `/category_type_create`;
  }
      ...
      <React.Fragment>
        ...
        <div className="container">
          ...
          <DataTable
            ...
            url={`${Config.api.base.url}${Routes.type.url}`}
